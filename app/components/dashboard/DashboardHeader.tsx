...
// Role is optional here to match ProjectContext.Project where role?: "owner" | "member" | "viewer"
...
export default function DashboardHeader({ project, id, queue }: DashboardHeaderProps) {
