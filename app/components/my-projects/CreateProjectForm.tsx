...
export default function CreateProjectForm({handleUpdateProject,projectTypes,isProjectSubmitting,projectErrors,settingsModalProjectId,currentProject,isOwner ,setSettingsModalProjectId,projectForm,setProjectForm}) {
  return (
    <div>
      {settingsModalProjectId !== null && currentProject && isOwner(currentProject.role) && (
